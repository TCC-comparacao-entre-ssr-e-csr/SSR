        ...
        <div className="row">
          ...
          <div className="col-3">
            <div className="icon__navbar__menu">
              <Image src="/static/images/e-commercesearch icon.svg" alt="" />
            </div>
            <div className="icon__navbar__menu">
              <Image src="/static/images/e-commerceuser icon.svg" alt="" />
            </div>
            <div className="icon__navbar__menu">
              <Image src="/static/images/e-commercecart icon.svg" alt="" />
            </div>
          </div>
        </div>
      </div>
